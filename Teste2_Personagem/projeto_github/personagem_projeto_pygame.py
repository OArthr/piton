...
def load_animation(path, frame_durations):
    ...
    for frame in frame_durations:
        ...
        animation_image = pygame.transform.scale(animation_image, (35, 25))
...
animation_database = {
    'run': load_animation('player_animations/run', [7, 7, 7, 7, 7, 7]),
    'idle': load_animation('player_animations/idle', [7, 7, 7, 7, 40])
}
